...
export function UpdatePrompt() {
  ...
  return (
    <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-full max-w-sm px-4">
      <div className="bg-ink text-white rounded-lg shadow-xl px-4 py-3 flex items-center gap-3">
        <div className="w-8 h-8 bg-paper text-ink rounded-lg flex items-center justify-center flex-shrink-0">
