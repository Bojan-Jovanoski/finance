        ...
        <div className="p-5 space-y-5">
          <form onSubmit={handleAdd} className="flex gap-2">
            <input
              ...
              className="flex-1 px-3 py-2.5 text-sm border border-rule rounded-lg focus:outline-none focus:ring-2 focus:ring-ink focus:border-transparent transition"
            />
            <button type="submit" className="px-4 py-2.5 bg-ink hover:bg-black text-white text-sm font-semibold rounded-lg transition-colors">
              Add
            </button>
          </form>
          {addError && <p className="text-xs text-debit -mt-3">{addError}</p>}
                  ...
                  <div className="space-y-2">
                    <div className="flex gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 text-sm border border-rule-bold rounded-lg focus:outline-none focus:ring-2 focus:ring-ink"
                    ...
                    <div className="relative">
                      <input
                        ...
                        className="w-full px-3 py-2 pr-10 text-sm border border-rule rounded-lg focus:outline-none focus:ring-2 focus:ring-ink"
                      />
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 bg-ink hover:bg-black text-white text-xs font-semibold rounded-lg transition-colors"
                      >
                        Save
                      </button>
                      <button
                        onClick={() => { setEditingId(null); setEditError(''); }}
                        className="px-3 py-1.5 text-xs text-ink-soft hover:text-ink rounded-lg transition-colors"
                      >
                        Cancel
                      </button>
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex-1 min-w-0">
                      <p className="text-sm text-ink truncate">
                        {cat.name}
                        {cat.isDefault && <span className="ml-1.5 text-xs text-ink-soft">default</span>}
                      </p>
                      {cat.monthlyLimit && (
                    ...
                    <button
                      ...
                      className="w-8 h-8 flex items-center justify-center rounded-lg text-ink-soft hover:text-ink hover:bg-ledgerbar transition-colors flex-shrink-0"
                      title="Edit"
                    >
