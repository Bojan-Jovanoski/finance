  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center px-4">
      <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 w-full max-w-md">
        {status === 'none' ? (
          <>
            <h2 className="text-lg font-semibold text-slate-900">Set up your shared household</h2>
            ...
            <button
              ...
              disabled={creating}
              className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-700 disabled:opacity-60 text-white text-sm font-medium rounded-xl transition-colors flex items-center justify-center gap-2"
            >
          ...
          <>
            <h2 className="text-lg font-semibold text-slate-900">Ask your partner to add you</h2>
            <p className="text-sm text-slate-500 mt-1 mb-5">
              The shared household already exists. Send this link code to your partner and ask them
              to add you from their <strong className="text-slate-700">Household</strong> screen.
              Once added, reload this page.
            </p>
            <label className="block text-xs font-medium text-slate-600 mb-1">Your link code</label>
